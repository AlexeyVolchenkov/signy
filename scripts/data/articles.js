const articles = [
  {
    id: '1',
    time: '05.03.2020',
    title: 'Burn Calories Quicker in 30 Min.',
    tags: [
      'про продукт',
      'теги',
      'Новости',
    ],
    description: 'Не следует, однако забывать, что дальнейшее развитие различных форм деятельности',
    fullContent: `
    <div class="blog-post__content">
      <div class="blog-post__content-left">
        <p>
        ...
        <img 
          src="images/blog-card/laptop-with-glasses.jpg" 
          alt="" 
          class="blog-post__content-image"
          width="586" height="460"
        />
        <p>
      ...
      <div class="blog-post__content-right">
        <img 
          src="images/blog-card/laptop-with-code.jpg" 
          alt="" 
          class="blog-post__content-image"
          width="586" height="423"
        />
        <p>
          Destinations & Ports of important Charter Companies  One of the greatest benefits of choosing a chartered cruise as a vacation is the choice. You will most likely have a rough itinerary and that can be affected by weather. However, you are flexible in deciding how long you want to stay in a particular port and if you want to add or subtract stops along the way.
        </p>
